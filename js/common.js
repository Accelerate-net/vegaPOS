...
/*
{
  "Call": {
    ...
    "AnsweredBy": null,
    "ForwardedFrom": null,
    "CallerName": "Zaitoon Customer Care",
...
function callTest(){
    ...
    $.ajax({
      type: 'POST',
      url: 'https://c5797dcbaaeed7678c4062a4a3ed2f8a:AUMWR_c5797dcbaaeed7678c4062a4a3ed2f8a@api.exotel.com/v1/Accounts/c5797dcbaaeed7678c4062a4a3ed2f8a/Calls/connect',
      ...
      success: function(data) { 
        if(data.success){
          alert('Call Success')
          if(data.responseData.Status == 'in-dial'){
            alert('>> Dialing')
          }
          else if(data.responseData.Status == 'in-progress'){
            alert('>> Picked Up')
          }
          else if(data.responseData.Status == 'missed'){
            alert('>> Missed Call')
          }
        }
        else{

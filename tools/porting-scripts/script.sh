...
echo 
echo [1/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_BILLING_MODES.json)
...
echo
echo [2/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_BILLING_PARAMETERS.json)
...
echo
echo [3/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_BILL_INDEX.json)
...
echo
echo [4/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_BILL_LAYOUT.json)
...
echo
echo [5/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_CANCELLATION_REASONS.json)
...
echo
echo [6/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_CONFIGURED_MACHINES.json)
...
echo
echo [7/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_CONFIGURED_PRINTERS.json)
...
echo
echo [8/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_COOKING_INGREDIENTS.json)
...
echo
echo [9/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_DINE_SESSIONS.json)
...
echo
echo [10/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_DISCOUNT_TYPES.json)
...
echo
echo [11/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_KOT_INDEX.json)
...
echo
echo [12/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_KOT_RELAYING.json)
...
echo
echo [13/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_MASTER_MENU.json)
...
echo
echo [14/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_MENU_CATALOG.json)
...
echo
echo [15/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_MENU_CATEGORIES.json)
...
echo
echo [16/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_ORDER_SOURCES.json)
...
echo
echo [17/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_PAYMENT_MODES.json)
...
echo
echo [18/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_PERSONALISATIONS.json)
...
echo
echo [19/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_SAVED_COMMENTS.json)
...
echo
echo [20/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_SAVED_ORDERS.json)
...
echo
echo [21/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_SHORTCUT_KEYS.json)
...
echo
echo [22/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_STAFF_PROFILES.json)
...
echo
echo [23/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_SYSTEM_OPTIONS.json)
...
echo
echo [24/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_TABLES_MASTER.json)
...
echo
echo [25/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_TABLE_SECTIONS.json)
...
echo
echo [26/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_TEXT_TO_KITCHEN_LOG.json)
...
echo
echo [27/27]
stub_data_received=$(curl https://raw.githubusercontent.com/Accelerate-net/vegaPOS/master/tools/settings-db-stub/ACCELERATE_TOKEN_INDEX.json)
